...
void Window::initialize_objects()
{
    ...
    const char * torsop = "/Users/apple/Downloads/CSE167StarterCode-master/emmm/startlatewaitforGG/startlatewaitforGG/bunny.obj";
    //cube = new Cube();
    // box = new skybox();
